...
/** Un événement dont la date de fin est dépassée devient un registre historique : verrouillé, quelle que soit son année. */
function isLockedPastEvent(toDate: string): boolean {
